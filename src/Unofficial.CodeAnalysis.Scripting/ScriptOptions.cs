...
using System.Text;
using Unofficial.CodeAnalysis.Scripting.Hosting.Resolvers;
using Unofficial.CodeAnalysis.Scripting.MetaReferences;
...
namespace Unofficial.CodeAnalysis.Scripting
{
    ...
    public sealed class ScriptOptions
    {
        ...
        private static readonly MetadataReferenceProperties s_assemblyReferenceProperties =
            GetAssemblyReferenceProperties();
        ...
        {
            var ctors = typeof(UnresolvedMetadataReference).GetConstructors(BindingFlags.NonPublic | BindingFlags.Instance)!;
            var instance = ctors.First().Invoke([reference, s_assemblyReferenceProperties]);

            return (UnresolvedMetadataReference)instance;
        }
        ...
        private static MetadataReference CreateReferenceFromAssembly(Assembly assembly)
        {
            ...
            if (s_assemblyReferenceProperties.Kind != MetadataImageKind.Assembly)
            {
                throw new ArgumentException("CantCreateModuleReferenceToAssembly");
            }
            ...
            return new MetadataImageReference(metadata, s_assemblyReferenceProperties, null, location, display: null);
        }
        ...
        private static MetadataReferenceProperties GetAssemblyReferenceProperties()
        {
            ...
            return (MetadataReferenceProperties)instance;
        }
    }
}
