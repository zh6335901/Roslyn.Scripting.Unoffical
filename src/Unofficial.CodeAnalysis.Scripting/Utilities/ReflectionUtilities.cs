...
namespace Unofficial.CodeAnalysis.Scripting.Utilities
{
    internal static class ReflectionUtilities
    {
        ...
        internal static MethodInfo? GetDeclaredMethod(this System.Reflection.TypeInfo typeInfo, string name, params Type[] paramTypes)
        {
            return FindItem(typeInfo.GetDeclaredMethods(name), paramTypes);
        }

        internal static ConstructorInfo? GetDeclaredConstructor(this System.Reflection.TypeInfo typeInfo, params Type[] paramTypes)
        {
